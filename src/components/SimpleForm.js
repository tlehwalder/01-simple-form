    ...
    render() {
        return <>
            ...
            <form onSubmit={this.onSubmit}>
                ...
                <Input title="Name" type="text" handleChange={this.onNameChange} value={this.state.name} placeholder={"Namen eingeben"}/>
                <Input title="Wohnort" type="text" handleChange={this.onCityChange} value={this.state.city}  placeholder={"Wohnort eingeben"}/>
                <Input title="Alter" type="text" handleChange={this.onAgeChange} value={this.state.age}  placeholder={"Alter eingeben"}/>
